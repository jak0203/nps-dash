...
export default class BarTooltip extends Component {
  render() {
    ...
    return (
      <g transform={transform}>
        <rect class="shadow" is width={width} height={height} rx="5" ry="5" visibility={visibility} fill="#6391da"
              opacity=".9"/>
        ...
        <text is visibility={visibility} transform={transformText}>
          ...
          <tspan is x="0" text-anchor="middle" dy="25" font-size="20px"
                 fill="#a9f3ff">{this.props.tooltip.data.value + " visits"}</tspan>
        </text>
      </g>
    );
  }
